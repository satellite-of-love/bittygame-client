...
Elm.Bittygame = Elm.Bittygame || {};
Elm.Bittygame.make = function (_elm) {
   "use strict";
   _elm.Bittygame = _elm.Bittygame || {};
   if (_elm.Bittygame.values)
   return _elm.Bittygame.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Bittygame",
   $Basics = Elm.Basics.make(_elm),
   $BittygameClient = Elm.BittygameClient.make(_elm),
   ...
   these) {
      return function () {
         switch (these.ctor)
         {case "::":
            switch (these._1.ctor)
              {case "[]": return these._0;}
              return function () {
                 var whyCantIMakeAnAnonymousFunctionWithTwoArguments = F2(function (e,
                 accum) {
                 ...
                 whyCantIMakeAnAnonymousFunctionWithTwoArguments,
                 these._0,
                 these._1);
              }();
            case "[]": return "";}
   ...
   var Exit = {ctor: "Exit"};
   var MakeMove = {ctor: "MakeMove"};
   var Input = function (a) {
      return {ctor: "Input",_0: a};
   };
   var StuffToPrint = function (a) {
      return {ctor: "StuffToPrint"
             ,_0: a};
   };
   ...
   model) {
      return function () {
         ...
         {case "Exit":
            ...
            return {ctor: "_Tuple2"
                   ,_0: model
                   ,_1: respondToThink(model)};
            case "YouWin":
            return {ctor: "_Tuple2"
                   ,_0: _U.replace([["won",true]],
                   model)
                   ,_1: $Effects.none};}
         _U.badCase($moduleName,
...
Elm.BittygameClient.make = function (_elm) {
   "use strict";
   _elm.BittygameClient = _elm.BittygameClient || {};
   if (_elm.BittygameClient.values)
   return _elm.BittygameClient.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "BittygameClient",
   $Basics = Elm.Basics.make(_elm),
      ...
      return function () {
         var handler = function (result) {
            return function () {
               switch (result.ctor)
               {case "Err":
                  return failureAction(result._0);
                  case "Ok":
   ...
   _elm.BittygameClient.values = {_op: _op
                                 ,beginGame: beginGame
                                 ,think: think
                                 ,turn: turn};
   return _elm.BittygameClient.values;
...
Elm.BittygameClient = Elm.BittygameClient || {};
Elm.BittygameClient.Serialization = Elm.BittygameClient.Serialization || {};
Elm.BittygameClient.Serialization.make = function (_elm) {
   "use strict";
   _elm.BittygameClient = _elm.BittygameClient || {};
   _elm.BittygameClient.Serialization = _elm.BittygameClient.Serialization || {};
   if (_elm.BittygameClient.Serialization.values)
   return _elm.BittygameClient.Serialization.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "BittygameClient.Serialization",
   $Basics = Elm.Basics.make(_elm),
   $BittygameClient$Types = Elm.BittygameClient.Types.make(_elm),
...
Elm.BittygameClient = Elm.BittygameClient || {};
Elm.BittygameClient.Types = Elm.BittygameClient.Types || {};
Elm.BittygameClient.Types.make = function (_elm) {
   "use strict";
   _elm.BittygameClient = _elm.BittygameClient || {};
   _elm.BittygameClient.Types = _elm.BittygameClient.Types || {};
   if (_elm.BittygameClient.Types.values)
   return _elm.BittygameClient.Types.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "BittygameClient.Types",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var ExitGame = {ctor: "ExitGame"};
   _elm.BittygameClient.Types.values = {_op: _op
                                       ,ExitGame: ExitGame
                                       ,Print: Print
                                       ,Win: Win
                                       ,State: State
